...
{
  my_upsample_ptr upsample = (my_upsample_ptr) cinfo->upsample;
  LOGM("estart_pass_merged_upsample");
              ...
              JSAMPARRAY output_buf)
{
  ...
  INT32 rgb;
  SHIFT_TEMPS
    LOGM("h2v1_merged_upsample_565D");
              ...
              JSAMPARRAY output_buf)
{
  ...
  INT32 rgb;
  SHIFT_TEMPS
    LOGM("h2v2_merged_upsample_565D");
