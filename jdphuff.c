...
{
  phuff_entropy_ptr entropy = (phuff_entropy_ptr) cinfo->entropy;
  LOGM("jpeg_get_huffman_decoder_configuration_progressive");
...
configure_huffman_decoder(j_decompress_ptr cinfo, huffman_offset_data offset)
{
  int i;
  phuff_entropy_ptr entropy = (phuff_entropy_ptr) cinfo->entropy;
  LOGM("configure_huffman_decoder");
...
{
       phuff_entropy_ptr entropy = (phuff_entropy_ptr) cinfo->entropy;
       LOGM("jpeg_configure_huffman_decoder_progressive");
...
{
  phuff_entropy_ptr entropy = (phuff_entropy_ptr) cinfo->entropy;
  LOGM("jpeg_configure_huffman_index_scan");
