 ...
 */
{
  LOGM("jpeg_core_output_dimensions");
...
{
  LOGM_S("finish_input_pass");
  cinfo->inputctl->consume_input = consume_markers;
#ifdef ANDROID
  cinfo->inputctl->consume_input_build_huffman_index =
         consume_markers_with_huffman_index;
#endif /* ANDROID */
  LOGM_E("finish_input_pass");
}
...
consume_markers (j_decompress_ptr cinfo)
{
  ...
  int val;
  LOGM_S("consume_markers");

  if (inputctl->pub.eoi_reached) { /* After hitting EOI, read no further */
    LOGM_E("consume_markers");
...
{
  LOGM("jpeg_decompress_per_scan_setup");
    per_scan_setup(cinfo);
}
...
consume_markers_with_huffman_index (j_decompress_ptr cinfo,
        huffman_index *index, int current_scan)
{
  LOGM("consume_markers_with_huffman_index");
