...
start_pass_huff_decoder (j_decompress_ptr cinfo)
{
  ...
  LOGM_S("start_pass_huff_decoder");
  ...
  LOGM_E("start_pass_huff_decoder");
}
        ...
        huffman_offset_data *offset)
{
  ...
  int i;
  LOGM("get_huffman_decoder_configuration");
...
{
  huff_entropy_ptr entropy = (huff_entropy_ptr) cinfo->entropy;
  LOGM("jpeg_get_huffman_decoder_configuration");
...
{
  huff_entropy_ptr entropy = (huff_entropy_ptr) cinfo->entropy;
  LOGM("jpeg_configure_huffman_decoder");
...
{
  int i, s;
  LOGM("jpeg_create_huffman_index");
  index->scan_count = 1;
...
{
    int i, j;
    LOGM("jpeg_destroy_huffman_index");
...
{
  LOGM("jset_input_stream_position");
...
{
  huff_entropy_ptr entropy = (huff_entropy_ptr) cinfo->entropy;
  LOGM("jset_input_stream_position_bit");
