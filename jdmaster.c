...
{
  LOGM_S("jpeg_calc_output_dimensions");
  ...
  LOGM_E("jpeg_calc_output_dimensions");
}
...
/* Allocate and fill in the sample_range_limit table */
{
  JSAMPLE * table;
  int i;
  LOGM_S("prepare_range_limit_table");
  ...
  LOGM_E("prepare_range_limit_table");
}
...
{
  my_master_ptr master = (my_master_ptr) cinfo->master;
  LOGM_S("prepare_for_output_pass");
  ...
  LOGM_E("prepare_for_output_pass");
}
...
jinit_master_decompress (j_decompress_ptr cinfo)
{
  ...
  LOGM_S("jinit_master_decompress");
  ...
  LOGM_E("jinit_master_decompress");
}
