...
extern void logm_end(const char* name);
...
#define LOGM_E(X)
#else
#define LOGM(X) { printf("+ "); printf(X); printf("\n"); }
#define LOGM_S(X) { logm_start(X); }
#define LOGM_E(X) { logm_end(X); }
#endif
